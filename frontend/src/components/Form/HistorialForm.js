...
const rows = [
  createData(
    ...
    "Pedido en tiempo",
    "2024-10-05",
    "Entregar en la oficina de administración"
  ),
  createData(
    2,
    24,
  ...
  createData(
    ...
    "Sin observaciones",
    "2024-09-11",
    "Confirmar con la Sra. Ana antes de entregar"
  ),
  createData(
    4,
    9,
    ...
    "Pedido en curso",
    "2024-09-05",
    "Llevar a la sala de profesores"
  ),
  createData(
    5,
    8,
    ...
    "Verificar peso",
    "2024-08-22",
    "Entregar a la Sra. Laura en el aula 3"
  ),
  createData(
    6,
    30,
    ...
    "Pedido especial",
    "2024-08-03",
    "Coordinar con el portero para la entrega"
  ),
  createData(
    7,
    7,
  ...
  createData(
    ...
    "Pedido programado",
    "2024-07-06",
    "Entregar a la docente en el patio"
  ),
  createData(
    9,
    90,
  ...
  createData(
    ...
    "Pedido en curso",
    "2024-05-25",
    "Confirmar entrega con la administración"
  ),
  createData(
    12,
    12,
    ...
    "Sin observaciones",
    "2024-05-03",
    "Entregar a la Sra. María en su oficina"
  ),
  createData(
    13,
    23,
    ...
    "Sin observaciones",
    "2024-04-22",
    "Entregar a la Sra. Julia en el salón 2"
  ),
  createData(
    14,
    25,
    ...
    "Pedido regular",
    "2024-04-05",
    "Coordinar entrega con el conserje"
  ),
  createData(
    15,
    27,
